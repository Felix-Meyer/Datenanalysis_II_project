...
def lorentz_transform(velocity_y, velocity_z, kaon_velocity):
    ...
    lorentz_matrix = np.array([[gamma, 0, -gamma * velocity_y / speed_of_light, -gamma * velocity_z / speed_of_light],
                               [0, 1, 0, 0],
...
ax.set_title('Particle Detections as a function of Detector Position')
ax.set_xlabel('Detector Position in meters')
ax.set_ylabel('Detections')
fig.savefig('divergent_kaons.png')
plt.show()
